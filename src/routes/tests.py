...
@dev_only
@tests_bp.route("/test-auth-required")
@allowed_user_required
...
@dev_only
@tests_bp.route("/test-logout-redirect")
@allowed_user_required
...
# Create a test route
@dev_only
@tests_bp.route("/test-config-error")
@allowed_user_required
...
@dev_only
@tests_bp.route("/test-double-protection")
@login_required
@allowed_user_required
...
@dev_only
@tests_bp.route("/test-protected-perf")
@allowed_user_required
...
@dev_only
@tests_bp.route("/test-unprotected-perf")
...
@dev_only
@tests_bp.route("/test-config-access")
@allowed_user_required
